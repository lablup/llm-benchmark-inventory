...
readme << ""
readme << "한국어·영어 LLM 벤치마크와 서빙 성능 도구, 공개 보드, GPU·엔진 자원 계측을 정리한 탐색형 인벤토리."
readme << "모델 능력과 시스템 성능을 같은 점수로 섞지 않고 별도 영역으로 제공한다."
readme << ""
...
readme << "## 영역 구분"
readme << ""
readme << "- **한국어·영어 벤치마크**는 모델 능력(model capability)을 평가하는 데이터셋과 하니스를 다룬다."
readme << "- **서빙·자원**은 지연·처리량을 재는 도구, 공개 성능 보드, GPU·엔진 계측을 다룬다."
readme << "- 외부 보드의 실시간 점수는 복제하지 않는다. 공식 방법론과 결과 페이지로 연결하고 재현 조건과 운영 상태를 기록한다."
readme << ""
readme << "## 읽는 방법"
readme << ""
